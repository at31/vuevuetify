...
export default {
    ...
    mounted() {
        ...
        self = this;
        if (this.selectedPO.length > 0 & this.selectedPO.length < 23) {
            this.error = false;
        ...
        } else if (this.selectedPO.length >= 23) {
            this.error = true;
        }
    },
    watch: {
...
function mapRender() {
    ...
    let _last = self.selectedPO.length - 1;
    let waypts = self.selectedPO.map(po => {
        return {
    ...
    console.log(waypts);
    var request = {
        origin: new google.maps.LatLng(self.selectedPO[0].latitude, self.selectedPO[0].longitude),
        destination: new google.maps.LatLng(self.selectedPO[_last].latitude, self.selectedPO[_last].longitude),
        waypoints: waypts,
